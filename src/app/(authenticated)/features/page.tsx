...
export default function FeaturesPage() {
  const { featureRequests, loading: ticketsLoading, error: ticketsError } = useTickets();
  ...
  const filteredFeatures = applyFilters(featureRequests);
      ...
      {ticketsError && (
        <Center py={60}>
          <Group gap="sm">
            ...
            <Text c="red" size="sm">
              Failed to load features: {ticketsError}
            </Text>
          </Group>
        </Center>
      )}
